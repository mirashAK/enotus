...
-- Функції
--
CREATE DEFINER=`root`@`%` FUNCTION `add_user`(in_login varchar(150), in_email varchar(150), in_pass varchar(250), in_data TEXT) RETURNS varchar(100) CHARSET utf8
    READS SQL DATA
BEGIN
...
CREATE DEFINER=`root`@`%` FUNCTION `reg_user`(reg_token varchar(40), ip varchar(15), exist_token varchar(40)) RETURNS text CHARSET utf8
    READS SQL DATA
BEGIN
...
INSERT INTO `public_users` (`u_id`, `u_f_user_id`, `u_name`, `u_f_country`, `u_f_lang`, `u_settings`, `read_level`, `write_level`, `owner`) VALUES
(1, 22, 'Евген', 4, 0, '4', 10, 21, 22),
(2, 23, 'Евгений', 1, 0, '1', 10, 21, 23),
(3, 24, 'Евгений', 1, 0, '1', 10, 21, 24);
...
(405, 24, '99456e131a94d674fccabee27833a1b5', '127.0.0.1', 'UmKQWIvsUZSPEOBxAXDtpVnV1QEfS18yY8Lwp/1F0jxp4NSolnK5ZDOgP+PmD5NY+US1zaeDe3g8xkGG2j95pA', '2013-07-31 10:11:10');
...
(1, '2:15:0.0', '2013-07-31 09:26:27', '1:05:0.0', 'ababagalamaga');
...
(24, '', 'evgen301@i.ua', '763259646ecb5234653b19809bacc972', 1, 4, '2013-07-31 09:11:13'),
(23, '', 'evgen306@i.ua', '763259646ecb5234653b19809bacc972', 1, 4, '2013-07-31 09:04:49'),
(22, '', 'evgen305@i.ua', '763259646ecb5234653b19809bacc972', 1, 4, '2013-07-31 09:02:22'),
(21, '', 'evgen304@i.ua', '636b1c7cc3103364e63f1c1bfe2e8612', 1, 4, '2013-07-31 08:30:25');
