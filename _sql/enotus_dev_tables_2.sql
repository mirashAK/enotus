...
--
-- Хост: localhost
-- Час створення: Сер 29 2013 р., 18:21
...
INSERT INTO `public_users` (`u_id`, `u_f_user_id`, `u_name`, `u_f_country`, `u_lang`, `u_settings`, `read_level`, `write_level`, `owner`) VALUES
(12, 26, 'Александр', 3, '0', NULL, 10, 21, 26),
(11, 25, 'Александр', 3, '0', NULL, 10, 21, 25),
(13, 27, 'Евгений', 3, '0', NULL, 10, 21, 27);
...
(416, 0, 'a323d365e9116dcfdcfde8b825a2f0ff', '127.0.0.1', 'FAOkgoyPVvhkGErV/AHvjZDUZLFkXS2uSkl1sttmP1urpx1NydYkP89f0MeLkDtiuE/DbQV3JG4zZCyrgNSZh+xUuSj6h1EoWSnlGBNmWj5FhvcadfA7h4RcHmHnnFRA', '2013-08-29 14:19:14');
...
(1, '2:15:0.0', '2013-08-29 12:29:04', '1:05:0.0', 'ababagalamaga');
