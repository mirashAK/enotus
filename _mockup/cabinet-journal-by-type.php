                            ...
                            <div class="tab-content">
                                ...
                                <div class="main-col">
                                    ...
                                    <ul class="filters _cfix">
                                        ...
                                        <li class="is-active" data-role="filter" data-option="popularity"><span >тип документа</span></li>
                                    ...
                                    <div class="result-list">
                                        ...
                                        <div class="acc-block">
                                            <div class="acc-head no-style js-acc-head">
                                                <h2>Расходные накладные</h2><i class="acc-head-arrow"></i>
                                            </div>
                                        ...
                                        <div class="acc-block">
                                            <div class="acc-head no-style js-acc-head">
                                                <h2>Расходно-кассовый ордер</h2><i class="acc-head-arrow"></i>
                                            </div>
                                        ...
                                        <div class="acc-block">
                                            <div class="acc-head no-style js-acc-head">
                                                <h2>Приходно-кассовый ордер</h2><i class="acc-head-arrow"></i>
                                            </div>
